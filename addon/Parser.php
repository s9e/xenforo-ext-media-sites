...
class Parser
{
	...
	*/
	protected static $sites = [
		...
		'medium'=>[['!medium\\.com/(?:s/\\w+/|@?\\w+/)?(?:\\w+-)*(?<id>[0-9a-f]+)!']],
		...
		'twentyfoursevensports'=>[['!247sports\\.com/PlayerSport/[-\\w]*?(?<player_id>\\d+)/Embed!'],[],[['extract'=>['!247sports\\.com/PlayerSport/[-\\w]*?(?<player_id>\\d+)/Embed!'],'header'=>'User-agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Safari/537.36','match'=>['!247sports\\.com/Player/[-\\w]*?\\d!']],['extract'=>['!player_id%3[Dd](?<video_id>\\d+)!'],'header'=>'User-agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Safari/537.36','match'=>['!247sports\\.com/Video/.!']]]],
