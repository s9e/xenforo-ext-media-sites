...
class Helper
{
	...
	*/
	public static function replaceIframes(Templater $templater, $type, $template, &$output)
	{
		...
		$output .= '<script>(function(e,h,g,t){function v(a){var b={capture:!0,passive:!0};a("click",l,b);a("load",l,b);a("resize",l,b);a("scroll",l,b)}function l(){clearTimeout(w);w=setTimeout(x,32)}function y(a){for(var b=h.createElement("iframe"),c=JSON.parse(a.getAttribute(g+"-iframe")),d=-1;++d<c.length;)b.setAttribute(c[d],c[++d]);b.loading="eager";2==b.getAttribute(g+"-api")&&(b.onload=D);c=a.parentNode;b.hasAttribute(g)||c.hasAttribute("style")||(c.className=t+"-inactive",c.onclick=E,b.addEventListener("transitionend",F));c.replaceChild(b,a)}function D(a){var b=a.target;a=new MessageChannel;b.contentWindow.postMessage("s9e:init",b.src.substr(0,b.src.indexOf("/",8)),[a.port2]);a.port1.onmessage=function(c){c=(""+c.data).split(" ");G(b,c[0],c[1]||0)}}function H(a){a=a.getBoundingClientRect();if(a.bottom>e.innerHeight)return 2;var b=-1;!z&&location.hash&&(b=m(location.hash,"top"));0>b&&(b=m(".p-navSticky","bottom"));return a.top<b?0:1}function m(a,b){return(a=h.querySelector(a))?a.getBoundingClientRect()[b]:-1}function G(a,b,c){var d=H(a),f=0===d||1===d&&1===n,I=f?m("html","height")-e.scrollY:0,p=a.style;if(1!==d||f||"complete"!==h.readyState)p.transition="none",setTimeout(function(){p.transition=""},32);p.height=b+"px";c&&(p.width=c+"px");f&&((a=m("html","height")-e.scrollY-I)&&e.scrollBy(0,a),k=e.scrollY)}function x(){k===e.scrollY?n=0:(z=!0,n=k>(k=e.scrollY)?1:0);"complete"===h.readyState&&(u=2*e.innerHeight,A=-u/(0===n?4:2));var a=[];q.forEach(function(b){var c=b.getBoundingClientRect();if(c.bottom<A||c.top>u||!c.width)c=!1;else{for(var d=b.parentNode,f=d;"BODY"!==d.tagName;)/bbCodeBlock-expandContent/.test(d.className)&&(f=d),d=d.parentNode;c=!(c.top>f.getBoundingClientRect().bottom)}c?b.hasAttribute(g+"-c2l")?J(b):y(b):a.push(b)});q=a;q.length||v(e.removeEventListener)}function E(a){a=a.target;var b=a.firstChild,c=a.getBoundingClientRect(),d=h.documentElement,f=b.style;f.bottom=d.clientHeight-c.bottom+"px";f.height=c.height+"px";f.right=d.clientWidth-c.right+"px";f.width=c.width+"px";b.offsetHeight;/inactive/.test(a.className)?(a.className=t+"-active-tn",b.removeAttribute("style"),r&&r.click(),r=a):(a.className=t+"-inactive-tn",r=null)}function F(a){a=a.target;var b=a.parentNode;/-tn/.test(b.className)&&(b.className=b.className.replace("-tn",""),a.removeAttribute("style"))}function J(a){a.hasAttribute(g+"-c2l-background")&&((a.hasAttribute(g)?a:a.parentNode.parentNode).style.background=a.getAttribute(g+"-c2l-background"));a.onclick=function(b){b.stopPropagation();y(a)}}for(var B=h.querySelectorAll("span["+g+"-iframe]"),C=0,q=[],A=0,u=e.innerHeight,w=0,z=!1,k=0,n=0,r=null;C<B.length;)q.push(B[C++]);setTimeout(function(){k=e.scrollY;v(e.addEventListener);x()},32)})(window,document,"data-s9e-mediaembed","s9e-miniplayer")</script>';
	}
