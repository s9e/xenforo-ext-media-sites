...
class Helper
{
	...
	*/
	public static function replaceIframes(Templater $templater, $type, $template, &$output)
	{
		...
		$output .= '<script>((e,k,h,u)=>{function w(a){["click","load","resize","scroll","visibilitychange"].forEach(b=>a(b,G,{capture:!0,passive:!0}))}function G(){e.clearTimeout(x);x=e.setTimeout(y,32)}function z(a){let b=-1,c=k.createElement("iframe"),d=JSON.parse(a.getAttribute(h+"-iframe"));for(;++b<d.length;)c.setAttribute(d[b],d[++b]);c.loading="eager";b=a.parentNode;c.hasAttribute(h)||b.hasAttribute("style")||(b.className=u+"-inactive",b.onclick=H,c.addEventListener("transitionend",I));a.replaceWith(c);2==c.getAttribute(h+"-api")&&(c.onload=J,a=g[A(c.src)],"string"===typeof a&&B(c,a))}function J(a){const b=new MessageChannel,c=a.target,d=A(c.src);b.port1.onmessage=f=>{const l=""+f.data;e.setTimeout(()=>{B(c,g[d]||l)},g[d]>+l?5E3:0);K(d,l)};c.contentWindow.postMessage("s9e:init","*",[b.port2])}function L(a){a=a.getBoundingClientRect();if(a.bottom>e.innerHeight)return 2;let b=-1;!C&&location.hash&&(b=m(location.hash,"top"));0>b&&(b=m(".p-navSticky","bottom"));return a.top<b?0:1}function m(a,b){return(a=k.querySelector(a))?a.getBoundingClientRect()[b]:-1}function B(a,b){b=b.split(" ");M(a,b[0],b[1]||0)}function M(a,b,c){const d=L(a),f=0===d||1===d&&1===n,l=f?m("html","height")-e.scrollY:0,p=a.style;if(1!==d||f||"complete"!==k.readyState)p.transition="none",e.setTimeout(()=>{p.transition=""},32);p.height=b+"px";c&&(p.width=c+"px");f&&((a=m("html","height")-e.scrollY-l)&&e.scrollBy(0,a),q=e.scrollY)}function y(){if("hidden"!==k.visibilityState){q===e.scrollY?n=0:(C=!0,n=q>(q=e.scrollY)?1:0);"complete"===k.readyState&&(v=2*e.innerHeight,D=-v/(0===n?4:2));var a=[];r.forEach(b=>{var c=b.getBoundingClientRect();if(c.bottom<D||c.top>v||!c.width)c=!1;else{let d=b.parentElement,f=d;for(;d;)/bbCodeBlock-expandContent/.test(d.className)&&(f=d),d=d.parentElement;c=c.top<=f.getBoundingClientRect().bottom}c?b.hasAttribute(h+"-c2l")?N(b):z(b):a.push(b)});r=a;r.length||w(e.removeEventListener)}}function H(a){a=a.target;const b=a.firstChild,c=a.getBoundingClientRect(),d=k.documentElement,f=b.style;f.bottom=d.clientHeight-c.bottom+"px";f.height=c.height+"px";f.width=c.width+"px";"rtl"===d.dir?f.left=c.left+"px":f.right=d.clientWidth-c.right+"px";b.offsetHeight&&/inactive/.test(a.className)?(a.className=u+"-active-tn",b.removeAttribute("style"),t&&t.click(),t=a):(a.className=u+"-inactive-tn",t=null)}function I(a){a=a.target;const b=a.parentElement;/-tn/.test(b.className)&&(b.className=b.className.replace("-tn",""),a.removeAttribute("style"))}function N(a){a.hasAttribute(h+"-c2l-background")&&((a.hasAttribute(h)?a:a.parentElement.parentElement).style.background=a.getAttribute(h+"-c2l-background"));a.onclick=b=>{b.stopPropagation();z(a)}}function A(a){return a.replace(/.*?ifram(e\/\d+\/\w+)[^#]*(#[^#]+).*/,"s9$1$2")}function K(a,b){try{if(.1>Math.random()&&g instanceof Storage){var c=g.length||0;if(100<c)for(;0<=--c;){const d=g.key(c)||"";/^s9e\//.test(d)&&.5>Math.random()&&g.removeItem(d)}}g[a]=b}catch{}}let E=k.querySelectorAll("span["+h+"-iframe]"),F=0,r=[],D=0,v=e.innerHeight,x=0,C=!1,q=e.scrollY,n=0,t=null,g={};for(;F<E.length;)r.push(E[F++]);try{g=e.localStorage}catch{}w(e.addEventListener);y()})(window,document,"data-s9e-mediaembed","s9e-miniplayer")</script>';
	}
