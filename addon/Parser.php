...
class Parser
{
	...
	*/
	protected static $sites = [
		...
		'gfycat'=>[['#gfycat\\.com/(?!gaming|reactions|stickers|gifs/tag)(?:gifs/detail/|ifr(?:ame)?/)?(?<id>\\w+)#'],[],[['extract'=>['!"height":(?<height>\\d+)!','!"width":(?<width>\\d+)!'],'match'=>['//'],'url'=>'https://api.gfycat.com/v1/oembed?url=https://gfycat.com/{@id}']],['height'=>['s9e\\MediaSites\\Parser::filterUint'],'width'=>['s9e\\MediaSites\\Parser::filterUint']]],
		...
		'googlesheets'=>[['@docs\\.google\\.com/spreadsheet(?:/ccc\\?key=|(?:[^e]/)+)(?<id>(?:e/)?[-\\w]+)[^#]*(?:#gid=(?<gid>\\d+))?@']],
		...
		'twentyfoursevensports'=>[['!247sports\\.com/PlayerSport/[-\\w]*?(?<player_id>\\d+)/Embed!'],[],[['extract'=>['!247sports\\.com/PlayerSport/[-\\w]*?(?<player_id>\\d+)/Embed!'],'match'=>['!247sports\\.com/Player/[-\\w]*?\\d!']],['extract'=>['!player_id%3D(?<video_id>\\d+)!'],'match'=>['!247sports\\.com/Video/.!']]]],
