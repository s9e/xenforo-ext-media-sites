...
class Parser
{
	...
	*/
	protected static $sites = [
		...
		'tiktok'=>[['#tiktok\\.com/(?:@[.\\w]+/video|v|i18n/share/video)/(?<id>\\d+)#'],[],[['extract'=>['#tiktok\\.com/@[.\\w]+/video/(?<id>\\d+)#'],'header'=>'User-agent: Mozilla/5.0 (X11; Linux x86_64; rv:62.0) Gecko/20100101 Firefox/62.0','match'=>['#//vm\\.tiktok\\.com/.#']]]],
