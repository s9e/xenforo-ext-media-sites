...
class Parser
{
	...
	*/
	protected static $sites = [
		...
		'cnbc'=>[['!cnbc\\.com/gallery/\\?video=(?<id>\\d+)!'],[],[['extract'=>["!content_id'\\s*:\\s*'?(?<id>\\d+)!"],'match'=>['!cnbc\\.com/video/20\\d\\d/\\d\\d/\\d\\d/\\w!']]]],
		...
		'msnbc'=>[[],[],[['extract'=>['@"video":\\{"current".*?id":"(?<id>\\w+)@'],'match'=>['@msnbc\\.com/[-\\w]+/watch/@','@on\\.msnbc\\.com/.@']]]],
