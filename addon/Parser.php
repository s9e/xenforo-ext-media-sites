...
class Parser
{
	...
	*/
	protected static $sites = [
		...
		'gfycat'=>[['#gfycat\\.com/(?!gaming|reactions|stickers|gifs/tag)(?:gifs/detail/|ifr(?:ame)?/)?(?<id>\\w+)#'],[],[['extract'=>['!meta [^>]*?="\\w+:\\w+:height" content="(?<height>\\d+)!','!meta [^>]*?="\\w+:\\w+:width" content="(?<width>\\d+)!'],'match'=>['//'],'url'=>'https://gfycat.com/ifr/{@id}']],['height'=>['s9e\\MediaSites\\Parser::filterUint'],'width'=>['s9e\\MediaSites\\Parser::filterUint']]],
